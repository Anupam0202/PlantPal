...
const FormSection: React.FC<{title: string, icon: React.ReactNode, children: React.ReactNode}> = ({title, icon, children}) => (
    <div className="p-4 sm:p-5 border border-slate-200 dark:border-slate-600 rounded-xl shadow-lg bg-white dark:bg-slate-700 hover:shadow-xl dark:hover:shadow-slate-600/50 transition-shadow duration-300">
        <h3 className="text-lg font-semibold text-emerald-700 dark:text-emerald-300 mb-3.5 flex items-center">
            <span className="mr-2.5 text-emerald-600 dark:text-emerald-400">{icon}</span> {/* Icon directly colored, container bg removed */}
            {title}
        </h3>
