...
const DataCard: React.FC<DataCardProps> = 
  ({ title, value, unit, icon, cardClassName = 'bg-white dark:bg-slate-700', textClassName='text-slate-500 dark:text-slate-400', valueTextClassName='text-emerald-600 dark:text-emerald-300' }) => (
    <div className={`p-4 rounded-lg shadow-md flex items-center space-x-3 transition-all duration-300 hover:shadow-lg ${cardClassName} border border-slate-200 dark:border-slate-600`}>
        {icon && <div className="text-emerald-600 dark:text-emerald-400">{icon}</div>} {/* Icon is directly colored */}
        <div>
...
export const EnvironmentalDataDisplay: React.FC<EnvironmentalDataDisplayProps> = ({ data, locationName }) => {
  ...
  return (
    <div className="mb-6 p-4 sm:p-5 bg-white dark:bg-slate-700 rounded-xl shadow-lg border border-slate-200 dark:border-slate-600">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <DataCard 
            ...
            // iconContainerClassName="bg-emerald-100 text-emerald-500 dark:bg-emerald-700/40 dark:text-emerald-300" // Removed
        ...
        <DataCard 
            ...
            // iconContainerClassName="bg-green-100 text-green-500 dark:bg-green-700/40 dark:text-green-300" // Removed
        ...
        <DataCard 
            ...
            // iconContainerClassName="bg-teal-100 text-teal-500 dark:bg-teal-700/40 dark:text-teal-300" // Removed
